...
export default function SnakeDraft({ roomCode, playerId }) {
  ...
  // TODO 1: if draftOrder is null and this player is the host, create it
  //   call shufflePlayers(playerIds) to get a random order
  ...
  return (
    <div>
      ...
      {/* Draft board — one column per player */}
